...
class ArticleApp extends MallbaseApp
{
    ...
    function index()
    {
        ...
        foreach ($articles as $key => & $value) {
            $value['description'] =  strip_tags($value['content']);
        }
        $this->assign('articles', $articles);
        $this->assign('mcategory', $category);
    ...
    function view()
    {
        ...
        $this->display('article.view2.html');
    }
    ...
    function _get_article_curlocal($cate_id)
    {
        ...
        {
            $curlocal[] = array('id' => $category['cate_id'], 'text' => $category['cate_name'], 'ACC' => $category['code'], 'url' => 'index.php?app=article&amp;cate_id=' . $category['cate_id']);
        }
        return $curlocal;
    }
