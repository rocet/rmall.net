...
class OrderApp extends ShoppingbaseApp
{
    ...
    function get_newly_sales(){
        ...
        foreach ($orders as $key => $value) {
            $return[] = array( 
                'order_time' => $value['add_time'],  
                'goods_name' => $value['goods_name'],  
                'goods_url' => url('app=goods&id='.$value['goods_id']) ,
                'img' => $value['goods_image'],  
                'consignee' => $value['buyer_name'], 
                'goods_price' => $value['price'],
            );
        }
        // order_time => add_time  goods_name => goods_name  goods_url => url('app=goods&id='.$goods_id) img => goods_image
        // consignee => buyer_name  goods_price => price
