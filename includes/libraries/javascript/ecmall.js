...
function getFullPath(obj)
{
    if(obj)
    {
        ...
        if (window.navigator.userAgent.indexOf("MSIE") >= 1)
        {
            ...
            // var localImagId = $('img[ectype="'+$(obj).attr('ectype').substring(7)+'"]').parent('p').get(0); // document.getElementById("localImag"); 
            ...
            // localImagId.filters.item("DXImageTransform.Microsoft.AlphaImageLoader").src = document.selection.createRange().text; 
            // } catch (e){} 
            // return false;
